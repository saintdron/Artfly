...
$xpath=stripslashes($_GET['xpath']);          //запрос XPATH. Удаляет экранирование символов()- удаляет экранирование символов
...
if (!$context || $context->length == 0) {
    ...
    $context=$domxpath->query('/'); //Возвращает объект DOMNodeList содержащий узлы, отвечающие условиям отбора в XPath
}
$context=$context->item(0); //возвращает узел находящийся в позиции 0 объекта DOMNodeList.
